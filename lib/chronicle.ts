...
export const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    title: "보이드의 해방",
    paragraphs: [
      "시간의 균열이 열렸다. 그 틈으로 보이드가 쏟아져 나왔다 — 생명을 오염시키고 잠식하는 이계의 침략자들. 베텔기우스가 복수를 위해 깨운 그것들은 순식간에 열두 행성으로 퍼져 나갔다.",
  ...
  },
  {
    ...
    title: "시간의 유적과 크로노텍터",
    paragraphs: [
      "세테라 함락이 눈앞에 다가온 어느 날, 뱅가드는 고대의 유적 — 시간의 유적으로 향했다. 그곳에는 센티넬에게 시간을 다루는 힘을 부여하는 유물, 크로노텍터가 잠들어 있었다.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "벨리아는 새로 센티넬이 된 주인공을 정확히 1년 전 과거로 돌려보냈다. 함께 전해진 말은 단 하나 — \"미래가 바뀌었다.\" 그녀가 무엇을 보았는지, 왜 하필 주인공이어야 했는지는 여전히 수수께끼로 남아 있다.",
      "과거로 돌아온 주인공 앞에서 벨리아는 크로노텍터의 새로운 힘을, 그리고 센티넬이 지닌 힘의 원천인 매트릭스의 실체를 하나씩 열어 보인다. 아직 오지 않은 멸망을 되돌리기 위한 싸움 — 크로노 오디세이의 이야기는 여기서 시작된다.",
    ],
    entity_ids: [
      "ENT-VELIA",
      "ENT-RODINIA",
